...
#    model=Post
#    Paginate_by=1
#use page_obj inspite of post_list in post_list.html
#change url pattern as url(r'^$',views.PostListView.as_view())
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject,message,'modis1559@gmail.com',[cd['to']])
            sent=True
    else:
        form=EmailSendForm()
